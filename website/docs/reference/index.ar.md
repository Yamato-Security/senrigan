...
## 📊 مخططات لوحة المعلومات — 115 مخططًا
...
| 🎯 Threat Detection | 14 | تجميع شامل للتهرب من الدفاع · فجوات التسجيل · العبث بسجل تدفق VPC/Config/EventBridge/WAF · تغييرات SCP/عضوية المؤسسة · اتجاهات الأخطاء والتقييد · نسبة الكتابة/القراءة · بطاقات مؤشرات محفّزات التصعيد P1/P2 |
...
<details markdown="1">
<summary>📋 القائمة الكاملة — جميع 115 مخططًا (انقر للتوسيع)</summary>
