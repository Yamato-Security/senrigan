...
|----------------|------------|--------------------|
| `aws-ct-timeline` | 🕒 **Suzaku Timeline** — 23 built-in hunts, AI chat, reports | Suzaku Detection Timeline(aws-ct-timeline) (44 charts) |
...
| 🔑 Identity | Top principals by severe detections · root-account activity profile · access keys behind detections · unattributed & service-principal detections |
