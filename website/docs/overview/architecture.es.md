...
Consulte [doc/ARCHITECTURE.md](https://github.com/Yamato-Security/senrigan/blob/main/doc/ARCHITECTURE.md#end-to-end-sequence-diagram) para ver el diagrama de secuencia del ciclo de vida completo.
