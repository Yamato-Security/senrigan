...
## 在數分鐘內獵捕 AWS 威脅 — 無需 SIEM，也不需要任何雲端基礎架構
> 只要放入您的 CloudTrail 日誌，即可獲得 100 多項可立即執行的威脅獵捕、一個 BI 儀表板，以及 AI 輔助分析
> — 全部都能在您的筆記型電腦上透過單一指令 `make up` 完成。
...
<img src="../assets/img-agent.png" width="800" alt="AI 聊天介面">

## 📊 80 多個預建儀表板圖表

<img src="../assets/img-dashboard.png" width="800" alt="Superset 儀表板">

## 🦅️ Suzaku 結果視覺化

<img src="../assets/img-suzaku-summary.png" width="800" alt="Suzaku 結果視覺化">

## 📄 HTML 威脅獵捕報告

<img src="../assets/img-html.png" width="800" alt="HTML 威脅獵捕報告">

## 🗺 AWS Config 資源圖

<img src="../assets/img-config.png" width="800" alt="AWS Config 資源圖">

## 適用對象
- 🔍 安全工程師 — 調查 AWS 帳戶遭入侵、權限提升或資料外洩
- 🛡 雲端安全團隊 — 在沒有專屬 SIEM 的情況下執行定期的雲端態勢檢視
- 🧑‍💻 開發人員與 SRE — 在事件發生期間或之後快速稽核自己帳戶的 CloudTrail 歷史紀錄
