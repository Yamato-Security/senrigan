...
## AWSの脅威を数分でハント — SIEM不要、クラウドインフラ不要
> CloudTrailのログを投入するだけで、すぐに実行できる100以上の脅威ハント、BIダッシュボード、AI支援による分析が手に入ります
> — すべて単一の `make up` でラップトップ上で完結します。
...
## 主な機能
## 🔍 100以上の組み込みハント + AIチャット

<img src="../assets/img-agent.png" width="800" alt="AIチャットUI">

## 📊 80以上の構築済みダッシュボードチャート

<img src="../assets/img-dashboard.png" width="800" alt="Supersetダッシュボード">

## 🦅️ Suzakuの結果の可視化

<img src="../assets/img-suzaku-summary.png" width="800" alt="Suzakuの結果の可視化">

## 📄 HTML脅威ハンティングレポート

<img src="../assets/img-html.png" width="800" alt="HTML脅威ハンティングレポート">

## 🗺 AWS Configリソースグラフ

<img src="../assets/img-config.png" width="800" alt="AWS Configリソースグラフ">

## 想定される利用者
- 🔍 セキュリティエンジニア — AWSアカウントの侵害、権限昇格、データ持ち出しを調査する方
- 🛡 クラウドセキュリティチーム — 専用のSIEMを持たずに定期的なクラウドポスチャレビューを実施する方
- 🧑‍💻 開発者およびSRE — インシデントの最中または後に、自身のアカウントのCloudTrail履歴を素早く監査する方
